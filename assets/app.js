...
const ERP = (function () {
  ...
  /* ---------- GABUNGAN JURNAL (Transaksi + Penyesuaian) ----------
     Dipakai oleh Buku Besar & Neraca Saldo supaya keduanya selalu
     mencerminkan saldo SETELAH penyesuaian, bukan cuma transaksi
     harian saja. Jurnal Umum tetap menampilkan transaksi harian
     saja (sesuai siklus akuntansi: transaksi -> AJP -> baru posting). */
  ...
  function getActiveJournalEntries() {
    ...
    return transactions.concat(adjustments);
  }
